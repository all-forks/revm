...
## [2.1.0](https://github.com/all-forks/revm/compare/op-revm-v2.0.0...op-revm-v2.1.0) - 2025-04-08
...
- clean unsed indicatif ([#2379](https://github.com/all-forks/revm/pull/2379))
- *(op-inspector)* Add test for inspecting logs ([#2352](https://github.com/all-forks/revm/pull/2352))
- *(op-tx)* Cover DepositTransactionParts constructor in test ([#2358](https://github.com/all-forks/revm/pull/2358))
