...
## [2.0.1](https://github.com/all-forks/revm/compare/revm-database-v2.0.0...revm-database-v2.0.1) - 2025-04-08
...
- *(database)* remove auto_impl dependency ([#2344](https://github.com/all-forks/revm/pull/2344))
