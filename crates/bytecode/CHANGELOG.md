...
## [2.1.0](https://github.com/all-forks/revm/compare/revm-bytecode-v2.0.0...revm-bytecode-v2.1.0) - 2025-04-08

### Added

- Iteration of bytecode opcodes ([#2349](https://github.com/all-forks/revm/pull/2349))
